...
class LegacyScoreBars extends BaseStage
{
	...
	{
		super.createPost();
		var scoreBg = game.hitmansHud.healthBarBG;
	...
	public function updateScoreText()
	{
		if (game.cpuControlled)
			game.scoreTxt.text = "Bot Play enabled";
		else
			game.scoreTxt.text = 'Score: ${FlxStringUtil.formatMoney(game.songScore, false, true)}';
	}
