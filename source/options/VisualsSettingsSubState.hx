...
class VisualsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		if (PlayState.SONG != null)
			PlayState.SONG.splashSkin = null; // Fix this component not working when entering from a song!
		...
		var option:Option = new Option('HUD Style', 'Style to display?', 'hudStyle', STRING, ['CLASSIC', 'HITMANS']);
		addOption(option);
