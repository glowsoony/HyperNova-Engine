...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [
			...
			[
				'Lily',
				'lily',
				'Contributed a mobile port of P-slice (no longer in the community)',
				'',
				'FFE7C0'
			],
			[
				"Fazecarl",
				'fazecarl',
				'Made the new logo for P-Slice',
				'https://gamebanana.com/members/2121406',
				'29170a'
			],
			[
				"Derpy The Hedgeone",
				'derpy',
				'Made a lot of PRs to the repo',
				'https://github.com/DerpyTheHedgeone',
				'd86b00'
			],
			[
				"Mykarm",
				'mykarm',
				'Made the new icon for P-Slice',
				'https://x.com/cronviersmeat/status/1849059676467417311?s=46&t=4dcTT7PAMkRJ8zYd4LgTow',
				'29170a'
			],
			[""],
			["P-Slice server"],
	...
	function pushModCreditsToList(folder:String)
	{
		...
		if (#if TRANSLATIONS_ALLOWED (NativeFileSystem.exists(translatedCredits) && (creditsFile = translatedCredits) == translatedCredits)
			|| #end NativeFileSystem.exists(creditsFile))
		{
