...
class Controls
{
	...
	private function get_FAVORITE()
		return justPressed('favorite');

	private function get_BAR_LEFT()
		return justPressed('bar_left');

	private function get_BAR_RIGHT()
		return justPressed('bar_right');
	...
	private function get_CHAR_SELECT()
		return justPressed('char_select');
